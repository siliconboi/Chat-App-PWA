const Type = () => {
    return (
      <div className="absolute top-[43.5rem] left-[0rem] bg-whitesmoke-100 flex flex-col pt-[0rem] px-[0rem]items-start justify-start text-left text-[0.88rem] text-gray-200 font-mulish">
